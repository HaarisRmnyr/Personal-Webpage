        ...
        <div className='h-24 max-w-[1240px] mx-auto text-white mt-4'>
            ...
            <div className={nav ? 'fixed left-0 top-0 w-[60%] h-full border-r-gray-900' : 'fixed hidden'} > 
                ...
                <li className='p-4 border-b border-gray-600'><a href="">Contact</a></li>
                 <a className="text-red-700 flex items-center justify-center w-40 h-10 border-2 text-red border-red-700 hover:text-white duration-300 hover:animate-pulse" href="./Downloadables/Haaris-Rahmanyar-Resume-FrontEnd.pdf" download>
